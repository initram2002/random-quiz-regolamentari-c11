...
if __name__ == "__main__":
    ...
    prev_quiz1 = [563, 312, 305, 285, 332, 614, 1, 403, 182, 603, 248, 93, 279, 355, 122, 551, 505, 64, 616, 224]  # Quiz 1
    prev_quiz2 = [564, 313, 307, 288, 333, 613, 2, 404, 181, 602, 249, 94, 280, 354, 123, 550, 506, 63, 617, 223]  # Quiz 2
    prev_quiz3 = [347, 66, 435, 162, 41, 189, 136, 595, 414, 529, 579, 276, 620, 302, 309, 85, 517, 262, 508, 606] # Quiz 3
